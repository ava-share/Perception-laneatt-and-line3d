...
D= np.array([-0.226197371057636, 0.152563798088415, 0.00281898531647650, 0.00109114101040129, 0.126644873146567])
width, height=2048, 1544
...
class Runner:
    ...
    def eval(self, epoch, on_val=False, save_predictions=False):
        ...
        if on_val:
            ...
            images= rospy.Subscriber("/camera_fl/image_rect_color", Image, self.img_callback,queue_size=1, buff_size=2**12) #subscribes to the image topic from ros (realtime or rosbag) /camera_fl/image_color  /image_proc_resize/image
            #waymo
    ...
    def img_callback(self, data):
        ...
        with torch.no_grad():
                ...
                msg = ros_numpy.msgify(Image,img, 'bgr8')
