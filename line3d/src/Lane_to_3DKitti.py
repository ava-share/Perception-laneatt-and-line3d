...
class realCoor():
    ...
    def __init__(self):
        ...
        self.pcdSub=message_filters.Subscriber("/demo/ground", PointCloud2)#/kitti/velo/pointcloud
        ...
        ts=message_filters.ApproximateTimeSynchronizer(([self.pcdSub, self.pointSub]),10, 0.1)
